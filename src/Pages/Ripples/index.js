...
function Ripples() {
    ...
    useEffect(() => {
        ...
        const animate = () => {
            ...
            ripplesRef.current = ripplesRef.current.filter((r) => (now - r.start) / 1000 < 10);
            ...
            for (let i = 0; i < cols; i++) {
                for (let j = 0; j < rows; j++) {
                    ...
                    const gradient = ctx.createLinearGradient(cellCenterX - halfSize, cellCenterY - halfSize, cellCenterX + halfSize, cellCenterY + halfSize);
    ...
    return _jsx(_Fragment, { children: _jsx("div", { ref: ref, className: "relative min-h-[100vh] h-[100%] w-[100%] min-w-[100vw] bg-gradient-to-br from-gray-900 via-indigo-900 to-purple-950  p-6 color1", children: _jsx("canvas", { ref: canvasRef, className: "fixed top-0 left-0  h-screen cursor-crosshair  z-0", role: "img" }) }) });
}
